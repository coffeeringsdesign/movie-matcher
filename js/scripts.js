...
var titanic = new Movie("Titanic", 0, 5, 0, 0, img, "A seventeen-year-old aristocrat falls in love with a kind but poor artist aboard the luxurious, ill-fated R.M.S. Titanic.", "https://www.imdb.com/title/tt0120338/");
...
// business
function Movie(title, happyCategory, sadCategory, angstCategory, loveCategory, image, description, href) {
  this.title = title;
